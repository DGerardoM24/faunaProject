<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="multimedia" class="form-control @error('multimedia') is-invalid @enderror" value="{{ old('multimedia', $multimedia?->multimedia) }}" id="multimedia" placeholder="Multimedia">
